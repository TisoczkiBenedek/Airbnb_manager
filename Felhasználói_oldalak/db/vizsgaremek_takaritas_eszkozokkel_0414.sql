...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Ápr 14. 19:07
...
--
-- Eseményindítók `eszkozszukseglet`
--
DELIMITER $$
CREATE TRIGGER `eszkozigenyLevonas` AFTER INSERT ON `eszkozszukseglet` FOR EACH ROW UPDATE eszkoz, eszkozszukseglet SET eszkoz.keszletenDB  = eszkoz.keszletenDB - NEW.igenyeltDarab, NEW.teljesitve = 1 WHERE NEW.eszkozId = eszkoz.id AND NEW.igenyeltDarab <= eszkoz.keszletenDB AND NEW.teljesitve = 0
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `tr_eszkozszukseglet_before_insert` BEFORE INSERT ON `eszkozszukseglet` FOR EACH ROW BEGIN
  DECLARE keszlet INT;


  SELECT keszletenDB INTO keszlet FROM eszkoz WHERE id = NEW.eszkozId;


  IF keszlet >= NEW.igenyeltDarab THEN
    SET NEW.teljesitve = 1;

    UPDATE eszkoz
    SET keszletenDB = keszletenDB - NEW.igenyeltDarab
    WHERE id = NEW.eszkozId;
  ELSE
    SET NEW.teljesitve = 0;
  END IF;
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `tr_eszkozszukseglet_before_update` BEFORE UPDATE ON `eszkozszukseglet` FOR EACH ROW BEGIN
  DECLARE keszlet INT;

  IF NEW.teljesitve = 1 AND OLD.teljesitve = 0 THEN
...
(15, 'valamiemial@gmail.com', '$2y$10$LXPW3JiPa7mp.ywwB13olOSL1tit3F6uJWSKzZiACYbwgmNSaoKlW', 'János', 'Pista', '06301234567', 19, 0, 1, 0, '0000-00-00', '0000-00-00'),
(17, 'tesztelünk@gmail.com', '$2y$10$mRKgnq2UkJx3hqYpPhiUYeNiToUopBxLzRy4.OD/RMNwktaGP02VC', 'Jelszo', 'Lajos', '04501234567', 19, 0, 1, 0, '0000-00-00', '0000-00-00');
...
(20, 'Veszprémi csoda', 'Vársomajos utca 19', 50, 0, 0, 5, 19, 'Valami szép lakás', '../php/uploads/lakas_20/kepek/1740940458_gt4rs.jpg'),
...
(74, 5, 'lakas', 'UPDATE', '2025-04-09 17:10:58'),
(75, 14, 'felhasznalo', 'INSERT', '2025-04-09 17:59:14'),
(76, 15, 'felhasznalo', 'INSERT', '2025-04-09 18:00:26'),
(77, 14, 'felhasznalo', 'DELETE', '2025-04-09 18:02:00'),
(78, 16, 'felhasznalo', 'INSERT', '2025-04-09 18:02:33'),
(79, 16, 'felhasznalo', 'DELETE', '2025-04-09 18:04:40'),
(80, 17, 'felhasznalo', 'INSERT', '2025-04-09 18:05:24');
