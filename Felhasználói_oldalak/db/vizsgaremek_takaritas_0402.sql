...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Ápr 02. 17:01
...
-- Események
--
CREATE DEFINER=`root`@`localhost` EVENT `TakaritoVisszallait` ON SCHEDULE EVERY 4 DAY STARTS '2025-03-19 17:30:18' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE `felhasznalo` SET `TakaritoSzabadsagKezd`= '0000-00-00', `TakaritoSzabadsagVeg` = '0000-00-00' WHERE `TakaritoSzabadsagVeg` = DATE(NOW())$$
