...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Jan 12. 17:48
...
CREATE TABLE `eszkoz` (
  ...
  `kiszereles` varchar(20) COLLATE utf8_hungarian_ci NOT NULL,
...
CREATE TABLE `felhasznalo` (
  ...
  `elerhetoseg` varchar(12) COLLATE utf8_hungarian_ci NOT NULL,
...
CREATE TABLE `lakas` (
  `id` int(11) NOT NULL,
  `nev` varchar(50) COLLATE utf8_hungarian_ci NOT NULL,
  `cim` varchar(70) COLLATE utf8_hungarian_ci NOT NULL,
  `terulet` int(11) NOT NULL,
  `medence` tinyint(4) NOT NULL,
  `szauna` tinyint(4) NOT NULL,
  `felhasznalo_id` int(11) NOT NULL,
  `megye_id` int(11) NOT NULL,
  `belepesi_adatok` varchar(100) COLLATE utf8_hungarian_ci NOT NULL,
...
CREATE TABLE `megye` (
  `id` int(11) NOT NULL,
  `megyeNev` varchar(50) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
...
CREATE TABLE `takaritas` (
  ...
  `megjegyzes` varchar(255) COLLATE utf8_hungarian_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_hungarian_ci;
